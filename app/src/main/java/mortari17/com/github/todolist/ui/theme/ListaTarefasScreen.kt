package mortari17.com.github.todolist.ui.theme
...
import mortari17.com.github.todolist.util.formatarDataHora
import mortari17.com.github.todolist.viewmodel.TarefaViewModel
...
private fun ConfirmarExclusaoDialog(
    ...
    AlertDialog(
        ...
        text = {
            Text(
                text = "A tarefa \"${tarefa.titulo}\" será excluída permanentemente. " +
...
@Composable
private fun ListaTarefasConfirmarExclusaoPreview() {
    val tarefas = listOf(
        Tarefa(id = 1, titulo = "Estudar Room", descricao = "Revisar anotações e DAO", concluida = false),
        Tarefa(id = 2, titulo = "Enviar atividade", descricao = "Upload no portal da FIAP", concluida = true)
    )
...
@Preview(showBackground = true, name = "Diálogo de exclusão")
@Composable
